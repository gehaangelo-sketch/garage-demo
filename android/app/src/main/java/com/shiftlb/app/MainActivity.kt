...
class MainActivity : AppCompatActivity() {
    ...
    private fun isAllowedHost(host: String): Boolean {
        if (host.endsWith("shiftlb.com") || host.endsWith("accounts.google.com") || host.endsWith("apis.google.com") || host.endsWith("oauth2.googleapis.com") || host.endsWith("www.googleapis.com") || host.endsWith("appleid.apple.com") || host.endsWith("xriitxzvlabrllibyoco.supabase.co")) return true
